        ...
        <div className="space-y-6">
          ...
          <div className="pt-6 border-t text-right space-y-2">
            <div className="flex justify-end">
              <div className="w-1/3 space-y-1 text-sm text-gray-700">
            ...
            <button
              onClick={onCheckout}
              className="mt-6 w-full sm:w-auto px-6 py-3 bg-[#D9BB96] text-[#272640] font-semibold rounded-md hover:bg-opacity-90 transition"
            >
              Proceed to Checkout
            </button>
          </div>
